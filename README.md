...
## 概要
このリポジトリは、2025/09/13にdely株式会社の3Daysインターンシップで作成されたものです。
アプリとしては「ハンズフリー料理アシスタント」を目指し、SpeechToTextで音声をテキスト化し、そのテキストをGeminiに成形させたうえで、その指示からフロントエンドを操作するというものです。
